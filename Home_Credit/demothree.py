...
del_columns = ["FLAG_DOCUMENT_2", "FLAG_DOCUMENT_3",
...
store = list(map(logfunc, predict))
predictfile = pd.DataFrame({'SK_ID_CURR': idnum, 'TARGET': store})
